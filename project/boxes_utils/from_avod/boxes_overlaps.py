...
def cal_iou_3d(boxes1, boxes2):
    ...
    # [tx, ty, tz, h, w, l, r] --> [r, l, h, w, tx, ty, tz]
    boxes1 = boxes1[:, [-1, 3, 4, 5, 0, 1, 2]]
    boxes2 = boxes2[:, [-1, 3, 4, 5, 0, 1, 2]]
    iou_3d = np.zeros((M, N), np.float64)
    for idx in range(M):
        box1 = boxes1[idx]
        iou_3d[idx] = three_d_iou(box1, boxes2)
    return iou_3d
