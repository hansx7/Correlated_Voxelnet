...
def rotate_iou_gpu_eval(boxes, query_boxes, criterion=-1, device_id=0):
    ...
    Args:
        boxes (float tensor: [N, 5]): rbboxes. format: centers, dims,
            angles(clockwise when positive) [x, y, h, w, r]
...
if __name__ == '__main__':
    boxes1 = np.array([[0, 0, 10, 10, np.pi / 4],
                       [2, 3, 5, 10, np.pi],
                       [5, 5, 10, 5, np.pi / 2],
                       [10, 10, 20, 10, np.pi / 4],
                       [20, 20, 10, 10, np.pi]
    ...
    boxes2 = np.array([[0.5, 0.5, 9.8, 10.2, np.pi / 4.2],
                       [2.4, 3.5, 5.5, 9.6, np.pi - 0.2],
                       [4, 6, 10, 5, np.pi / 2.5],
                       [5, 10, 10, 10, np.pi / 4],
                       [20, 20, 10, 10, np.pi]
                       ])
    iou = rotate_iou_gpu_eval(boxes1, boxes2, device_id=2)
    print(iou)
